...
\begin{itemize}
    ...
    \item Participated in the \textit{University Student Scientific Research Conference}, earning a third prize.
    ...
    \item Presented a poster at the \textit{\(3^{rd}\) APSIPA Workshop}, gaining international exposure.
\end{itemize}
